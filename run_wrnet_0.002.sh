...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m ieg.main --dataset=cifar10_uniform_0.8 --network_name=wrn28-10 --probe_dataset_hold_ratio=0.002 --checkpoint_path=ieg/checkpoints/ieg 
